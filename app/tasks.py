...
def process_file(file_path, filename, folder_id, file_id, user_tags, current_user, file):
    ...
    with app.app_context():
        ...
        for i in range(50000):
            redis.rpush('processed_files', json.dumps({'filename': filename, 'folder_id': folder_id, 'file_id': file_id, 'user': current_user, 'file': file}))
